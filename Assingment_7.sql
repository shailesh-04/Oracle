...
39. List the total information of EMP table along with DNAME and Loc of all the emps 40. List the Empno, Ename, Sal, Dname of all the ‘MGRS’ and ‘ANALYST’ working in New York, Dallas with an exp
...
ii. 3⁄4 Sal of any Mgr of EMP2 table.
iii. The sal of any person with exp of 5 years belongs to the sales dept of emp3 table.
iv. Any grade 2 employee of emp4 table.
v. Any grade 2 and 3 employee working fro sales dept or operations dept joined in 89.
